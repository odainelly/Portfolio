...
// i am almost certain the overflow error is from the about.jsx solve it later it has to either do the max-widths or div structure
	...
	return (
		...
		>
			<div className="flex h-full w-full flex-col items-center justify-center">
				<div className=" flex items-center justify-center w-full max-w-[1000px] gap-8">
					<div className=" flex justify-center items-center pb-8 pl-4 sm:text-right">
                        <p className='w-8 md:w-11 h-[2px] bg-[#fff] '></p>
						<p className="inline  text-4xl font-bold text-white">
							About
						</p>
					</div>
				</div>
				<div className="grid w-full max-w-[1000px] gap-8 px-4 sm:grid-cols-2">
					<div className="text-4xl font-bold sm:text-right">
						<p>Computer science student and a software developer.</p>
					</div>
